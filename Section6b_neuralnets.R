...
#Positive Score: A positive value indicates that the variable has a positive 
# impact on predicting the corresponding class. In other words, an increase 
# in the value of the variable is associated with an increase in the likelihood or
# probability of that class.
# Negative Score: A negative value indicates that #
#the variable has a negative impact on predicting the corresponding class.
# In other words, an increase in the value of the variable is associated with a 
# decrease in the likelihood or probability of that class.
# Magnitude of Score: The magnitude of the score represents the strength
# of the variable's influence on predicting the class. Larger absolute values 
